...
function agregar(){
	...
	alert("Se agrego el artículo de tipo moda");
}
...
function elaboradoCreada (numero){
	if(numero != null) {
		alert("Se creo el artículo de tipo moda:" + numero);
	}
...
<body>
	...
	<div id="headerwrap">
		...
		<table class="table table-striped">		
			<tr>
				<td colspan="2" align="center">Crear Artículo Moda</td>
			</tr>
		...
		// Moda: color y talle	
		 -->
		 	...
		 	<tr>
				<td>Tipo: </td>
				<td><input class="form-control" name="tipo" id="tipo" value="Moda" readonly="readonly"></td>
			</tr>
			...
			<tr>
				<td>Talle: </td>
				<td><input class="form-control" type="TEXT" name="talle" id="talle"></td>
			</tr>
