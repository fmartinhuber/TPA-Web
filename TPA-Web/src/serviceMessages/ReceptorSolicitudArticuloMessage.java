...
public class ReceptorSolicitudArticuloMessage implements MessageListener {
	...
	public void onMessage(Message message) {
    	...
    	deposito.crearSolicitudArticulo(message.toString());
    	
    //Daro 14.11: Esto quedo mal mergeado, le pasamos el json a deposito.crear solicitud y que se arregle
    //MAS CUIDADO CON LOS MERGE PORFA!
